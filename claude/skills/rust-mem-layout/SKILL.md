...
Fix mode applies one pattern after another. Continue to the next pattern in the
same turn. A decision the run genuinely needs from the user, such as a benchmark
regression, still ends the turn.
