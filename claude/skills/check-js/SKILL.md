...
name: check-js
description: >
  JavaScript or TypeScript security and code-quality scan of the whole project. Runs FOUR tools by default — the package manager's audit (CVEs), semgrep
  (security static analysis), ESLint (lint), and knip (dead code and unused
  dependencies) —
