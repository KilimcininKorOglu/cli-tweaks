...
This subcommand replaces the old standalone `/disaster-recovery` skill.

## Command

```bash
/bug-report disaster-recovery [--focus data-loss|system-failure|security-breach|human-factor|recovery-plan|all]
```
