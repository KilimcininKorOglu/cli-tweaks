...
if hasMemory:
    reason = (
        ...
        "4. Write in English ONLY. Rules 4 to 8 apply to MEMORY.md and to every topic file "
        "alike.\n"
        "5. Write every entry to ASD-STE100 (Simplified "
    ...
    reason = (
        ...
        "character cap (under 50000) — and in English ONLY. Every writing rule here applies to "
        "MEMORY.md and to every topic file alike. "
        "Each bullet is ONE focused project rule or fact; no narrative or padding. Write every "
        "entry to ASD-STE100 (Simplified Technical "
