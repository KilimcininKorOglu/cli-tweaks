...
description: >-
  ...
  claim validation. If no JWT usage is found in Phase 1,
...
> **Goal**: Map how the application creates, transmits, and verifies JWTs. Identify every JWT issuance and verification site, the library used, the signing algorithm and key/secret configuration, and the claims that are used for authorization. Write results to `Phase 1 findings`.
>
...
>
> **Severity mapping**:
> - alg:none / algorithm confusion → CRITICAL
> - Missing signature validation → HIGH
> - Weak/hardcoded secret → HIGH
>
