...
| Alt komut              | Komut                              | Açıklama                                                            |
|------------------------|------------------------------------|---------------------------------------------------------------------|
| `security-sweep`       | `/bug-report security-sweep`       | 28 güvenlik taramasını rolling 2-worker havuzuyla çalıştırır        |
...
| `privilege-escalation` | `/bug-report privilege-escalation` | Rol yükseltme, sahte rol claim ve korumasız admin route tespiti     |
| `race-condition`       | `/bug-report race-condition`       | Paylaşılan durum üzerinde race condition ve TOCTOU tespiti          |
| `iac`                  | `/bug-report iac`                  | Terraform, Kubernetes, Helm ve cloud template yanlış yapılandırması |
| `local-ipc`            | `/bug-report local-ipc`            | Masaüstü ve mobil IPC, webview bridge ve deep link güvenliği        |
